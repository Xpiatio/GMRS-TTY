#!/usr/bin/env python3
"""Pre-stage the offline Whisper model GMRS-TTY needs.
...
Usage:
    ...
    # model in one run. large-v3-turbo is what whisper_model_final="auto"
    # prefers:
...
WHISPER_REPOS = {
    ...
    # a good whisper_model_final for the two-pass RX pipeline.
