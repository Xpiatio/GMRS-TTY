...
offline eval CLI (gmrs_tty.tools.eval_stt).

The capture buffer taps the same raw-audio fanout the live STT worker already
emits (the STTWorker audio_chunk signal) — no changes to the worker or its
...
from gmrs_tty.tools.eval_stt import EvalPipelineConfig, run_pipeline
from gmrs_tty.stt.wer import score
