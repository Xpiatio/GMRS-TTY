"""Word-error-rate scoring shared by the offline eval CLI (gmrs_tty.tools.eval_stt)
and the in-app STT calibration wizard (gmrs_tty.stt.calibration), so both score
