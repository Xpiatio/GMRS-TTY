...
Extracted from STTWorker.run() so it can be unit-tested without an audio
device or ML model, and so STTWorker owns only I/O + Qt signal routing.
"""
...
from gmrs_tty.audio.vad import reset_vad_state
...
class SpeechSegmenter:
    ...
    to a transcription queue, plus a list of capture-event strings for the
